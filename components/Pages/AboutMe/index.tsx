      ...
      <Content>
        ...
        {activeMenu === 0 && (
          <Info>
            ...
            <p>
              Desenvolvedor web full stack a mais de 4 anos, encontrei no front-end a minha paixão.
              Busco entregar em todos os meus projetos: Fidelidade, Usabilidade e Experiência.
              <br />
              <br />
              Atualmente, atuo como desenvolvedor FrontEnd Pleno na Samba Digital, braço focado em transformação digital da Sambatech. Atuando em projetos para empresas como C&A, AmBev, ETC Filmes e Porto Seguro. Além de participar do desenvolvimento de Produtos internos da organização.
            </p>
          ...
          <Work>
            ...
            <div>
              ...
              <div>
                ...
                <p>Sistemas baseados em vídeo como LMS(Learning Management System) e OTT(Over The Top). Se destaca aplicação desenvolvida para ETC Filmes (Ping Play), OTT focado em acessibilidade, onde atuei como squad lead e dev frontend.</p>
              </div>
            </div>
